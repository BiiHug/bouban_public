...
##read movie_id list
file = open('/Applications/学习/UWM/new479/douban_public/douban_public/data/movie_list.txt','r')
movie_R = file.readlines()[1:]
file.close()
movie_list = []
for line in movie_R:
    movie_list.append(re.findall('\d+',line)[0])
...
for j in range(0, len(movie_list)):
    ...
    HH_dataframe.to_csv('/Applications/学习/UWM/new479/douban_public/douban_public/data/movie_info/'+str(list_index)+'.csv')
